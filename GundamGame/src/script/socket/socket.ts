import { playerTest, setPlayerTest } from "../main"
import { game } from "../main"
import Player from "../player/player"
import { State } from "../player/playerState"
...
export const createWebSocket = (url: string, onMessage: (data: string) => void): Promise<GameWebSocket> => {
        ...
        socket.onmessage = (event) => {
            try {
                ...
                if (label.trim() === "player_command") {
                    ...
                    if (game.first_player.id !== data.Id) {
                        game.second_player = {
                            ...game.second_player, // Spread to keep existing properties
                            x: data.X,
                            y: data.Y,
                            width: data.Width,
                            height: data.Height,
